Terraform AWS Billing Policy
============================

[![CircleCI](https://circleci.com/gh/infrablocks/terraform-aws-billing-policy.svg?style=svg)](https://circleci.com/gh/infrablocks/terraform-aws-billing-policy)

A Terraform module for managing an AWS IAM policy allowing viewing or modifying
billing information.
...
See the 
[Terraform registry entry](https://registry.terraform.io/modules/infrablocks/billing-policy/aws/latest) 
for more details.
...
https://github.com/infrablocks/terraform-aws-billing-policy. 
